 ...
 * @className: BufferedHomeWorkDemo1
 * @Description: // TODO: 2020/3/22  使用高效流 实现文件的复制
 * @author: YangLei
 * @date: 2020/3/22 8:40 下午
 */
public class BufferedHomeWorkDemo1 {
    public static void main(String[] args) throws IOException {
        System.out.println(bufferedCopyFile("/Users/yanglei/javaText1/a.txt", "/Users/yanglei/javaText3"));
    }

    public static boolean bufferedCopyFile(String old, String now) throws IOException {
        /*
    ...
    private static void copyFile1ToFile2(File file, File file2) throws IOException {
        ...
        // 创建高效读入流
        BufferedWriter bufferedReader1 = new BufferedWriter(new FileWriter(file2));
        // 创建高效写入流
        while (true){
